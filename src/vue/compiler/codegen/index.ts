...
import { camelize, no, extend, capitalize } from "vue/src/shared/util";
...
import {
  ...
  ASTText,
  CompilerOptions,
} from "vue/src/types/compiler";
import { BindingMetadata } from "vue/packages/compiler-sfc/src/types";
